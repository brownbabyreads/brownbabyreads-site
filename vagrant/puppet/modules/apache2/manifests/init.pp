...
class apache2::install {
  ...
  file { '/etc/apache2/conf-available/user.conf':
    source  => '/vagrant/vagrant/files/etc/apache2/httpd.conf',
  }
  ...
  file { '/etc/apache2/sites-available/default.conf':
    source  => '/vagrant/vagrant/files/etc/apache2/sites-available/default.conf',
  }

  file { '/etc/apache2/mods-available/rewrite.load':
    source  => '/vagrant/vagrant/files/etc/apache2/mods-available/rewrite.load',
  }
