...
function _bbr_setup() {
    ...
    'login_nav' => __( 'Login Nav', '_bbr' ),
    'profile_nav' => __( 'User Profile Nav', '_bbr' ),
...
function _bbr_scripts() {
	...
	wp_enqueue_script( '_bbr-jquery', get_template_directory_uri() . '/js/jquery-2.1.3.min.js', array( 'jquery' ), '2.1.3', true );
