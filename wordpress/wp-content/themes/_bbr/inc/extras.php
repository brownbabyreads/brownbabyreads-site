...
// Hook into the 'init' action
add_action( 'init', 'custom_articles', 0 );

// ACF Articles
if( function_exists('acf_add_local_field_group') ):
  acf_add_local_field_group(array (
    'key' => 'group_555f2a9655692',
    'title' => 'Article',
    'fields' => array (
      array (
      ...
      array (
        'key' => 'field_555f2b65b5390',
        'label' => 'Article Link',
        'name' => 'article_linkarticle_link',
        'type' => 'text',
        'instructions' => '',
        'required' => 0,
        'conditional_logic' => 0,
